...
export const HomepageHero = () => (
 ...
 <button className='relative inline-flex h-12 overflow-hidden rounded-full p-[2px] w-full sm:w-auto hover:scale-105 duration-300 active:scale-110 mb-20'>
...
<img src="heroimg1.png" alt="Hero Image" className=""/>
